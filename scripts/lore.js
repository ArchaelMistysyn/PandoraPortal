const loreContent = {
    story1: "Placeholder Text 1...",
    story2: "Placeholder Text 2...",
    story3: "Placeholder Text 3...",
    story4: "Placeholder Text 4...",
    prequel1: "Placeholder Text 1...",
    prequel2: "Placeholder Text 2...",
    prequel3: "Placeholder Text 3...",
    prequel4: "Placeholder Text 4..."
};
const storyUnlocks = {
    ...
    .then(data => {
        if (data.success) {
            ...
            if (storyKey !== null) {
                ...
                readHTML += "<p>" + loreContent[storyKey] + "</p>";
                readHTML += "<p>Format testing</p>";
